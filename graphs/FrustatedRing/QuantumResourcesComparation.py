...
graph_type = "probabilities"  # "max_entanglement", "max_magic", "final_energy", "entanglement_integral", "magic_integral", "min_gap", "probabilities", "schedules", "energy_spectrum", "entanglement_evolution", "magic_evolution"
...
if graph_type == "min_gap":
...
elif graph_type == "max_entanglement":
    ax1.plot(
        Tlist_linear,
        max_entanglement_linear,
        ".-",
...
elif graph_type == "entanglement_integral":
    ax1.plot(
        Tlist_linear,
        entanglement_integral_linear,
        ".-",
...
elif graph_type == "magic_integral":
    ax1.plot(
        Tlist_linear,
        magic_integral_linear,
        ".-",
...
elif graph_type == "energy_spectrum":
    times = data_LZR[T]["times"]
    for i in range(nlevels):
        ax1.plot(
            times,
...
elif graph_type == "entanglement_evolution":
    ...
    ax2.plot(
        times_LZR2, entanglement_LZR2, ".-", linewidth=1, markersize=4.5, label="LZR"
    )
    ax2.legend()
    ax2.set_xlabel(r"$t$")
    ax2.grid()
    fig.suptitle("Entanglement Evolution vs Time")
elif graph_type == "magic_evolution":
    times_linear = data_linear[T]["time_sub"]
    ...
    ax1.plot(
        times_linear, magic_linear, ".-", linewidth=1, markersize=4.5, label="Linear"
    )
    ax1.plot(
        times_linear,
        magic_linear_gs,
    ...
    ax2.plot(
        times_linear2, magic_linear2, ".-", linewidth=1, markersize=4.5, label="Linear"
    )
    ax2.plot(
        times_linear2,
        magic_linear_gs2,
