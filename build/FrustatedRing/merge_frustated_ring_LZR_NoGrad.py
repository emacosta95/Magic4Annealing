...
patron_archivo = os.path.join(directorio, "QuantumResourcesvsT_T=*_LZR_NoGrad.npz")
archivo_salida = os.path.join(directorio, "QuantumResourcesvsT_LZR_NoGrad.npz")
...
patron_regex = re.compile(r"QuantumResourcesvsT_T=([\d.]+)\_LZR_NoGrad.npz$")
