...
patron_archivo = os.path.join(directorio, "QuantumResourcesvsT_T=*_LZR_no_random.npz")
archivo_salida = os.path.join(directorio, "QuantumResourcesvsT_LZR_no_random.npz")
...
patron_regex = re.compile(r"QuantumResourcesvsT_T=([\d.]+)\_LZR_no_random.npz$")
