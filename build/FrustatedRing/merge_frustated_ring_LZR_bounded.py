...
patron_archivo = os.path.join(directorio, "QuantumResourcesvsT_T=*_LZR_bounded.npz")
archivo_salida = os.path.join(directorio, "QuantumResourcesvsT_LZR_bounded.npz")
...
patron_regex = re.compile(r"QuantumResourcesvsT_T=([\d.]+)\_LZR_bounded.npz$")
