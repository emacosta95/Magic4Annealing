...
patron_archivo = os.path.join(
    directorio, f"QuantumResourcesvsT_N={N}_T=*_LZR_bounded_more_T.npz"
)
archivo_salida = os.path.join(
    directorio, f"QuantumResourcesvsT_N={N}_LZR_bounded_more_T.npz"
)
...
patron_regex = re.compile(
    rf"QuantumResourcesvsT_N={N}_T=([\d.]+)\_LZR_bounded_more_T.npz$"
)
